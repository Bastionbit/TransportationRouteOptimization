...
CREATE TABLE tipo_empleados (
	tipo INT IDENTITY NOT NULL PRIMARY KEY,
...
insert into sedes values ('MADRID', 'Madrid' , 20046, 'Paseo La Castellana', 101);
...
insert into sedes values ('A CORUÑA', 'Ares' , 15624, 'Rua Real', 54);
...
insert into tipo_empleados values (12000, 'junior 1');
insert into tipo_empleados values (12000, 'junior 2');
insert into tipo_empleados values (13000, 'junior 3');
insert into tipo_empleados values (14000, 'junior 4');
insert into tipo_empleados values (15000, 'senior');
...
select * from estado_paquetes;

insert into paquetes values(10, '10/23/58', 'enviado', 4, 1, 'Maria', 'Juan', 'Calle 24 de los pepinos', 03015, 685254458, 685254458, 'Avenida de las sandias', 04012); 
insert into paquetes values(22, '11 03 08', 'extraviado', 2, 4, 'Pedro', 'Carlos', 'Calle 22 de los pepinos', 03016, 685255558, 685254458, 'Avenida de las sandias 3', 04012); 
insert into paquetes values(03, '21-10-58', 'en espera', 3, 5, 'Anna', 'Salva', 'Calle 13 de los pepinos', 09012, 685892658, 650395920, 'Avenida de las sandias 52', 04012); 
...
ADD longitud float, latitud float;

ALTER TABLE sedes
ADD longitud FLOAT, latitud FLOAT;

alter table sedes add telefono int;
